...
class SecurityAccount(PolyModel):
    ...
    admin_access = db.BooleanProperty(default=False)
    superadmin_access = db.BooleanProperty(default=False)
...
class ProtoHelper(DataManager):
    ...
    def insert(self):
        ...
        self.models.append(self.P(_class=GroupAccount,
                                    direct_parent=db.Key.from_path('P','SecurityAccount'),ancestry_path=['SecurityAccount'],abstract=False,derived=True,is_data=False,poly_model=True,uses_keyname=True,uses_parent=False,uses_id=False,
        ...
        self.models.append(self.P(_class=GenericKey,
                                    direct_parent=db.Key.from_path('P','SecurityKey'),ancestry_path=['SecurityKey'],abstract=False,derived=True,is_data=False,poly_model=True,uses_keyname=True,uses_parent=False,uses_id=False,
                                   created_modified=True,keyname_use='Key value, generated by the Security API.',keyid_use=None,keyparent_use=None))
                                   
        self.models.append(self.P(_class=AccountKey,
                                    direct_parent=db.Key.from_path('P','SecurityKey'),ancestry_path=['SecurityKey'],abstract=False,derived=True,is_data=False,poly_model=True,uses_keyname=True,uses_parent=True,uses_id=False,
    ...
    def base(self):
        ...
        self.models.append(UserAccount(user=users.User('s@providenceclarity.com'),activated=True,do_captcha=False,beta_access=True,admin_access=True,superadmin_access=True))
